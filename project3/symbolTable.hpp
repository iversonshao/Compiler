...
struct ID{
    ...
    ID(int vvaf, const char *s, int type, int inte, bool bool2, string stri){
...
void insert(int vvaf, const char *s, int type, int integer, bool bool1, string str){
...
void dump()
{
    ...
    while (iter_table != nullptr){
        ...
        for (int i = 0; i < iter_table->id.size(); i++){
            ...
            else if (iter_table->id[i].data_type == 1)
            {
                temp_data_type = "REAL";
            }
            ...
            else if (iter_table->id[i].data_type == 4)
            {
                temp_data_type = "VOID";
            }
            else if (iter_table->id[i].data_type == 5)
            {
